...
CREATE TABLE `zap2_records` (
  ...
  `decision_num` longtext DEFAULT NULL,
  `decision_org` longtext DEFAULT NULL,
...
('getDumpDeltaList',2), /* состояние для зонда, что можно начать резолвить IP*/
('getDumpDelta',0), /*тут пишим deltaId*/
('actualDate','2017-11-30T17:20:04+03:00'),
